...
enum ShadowGeometryCalculator {
    ...
    static func rayPlaneIntersection(rayOrigin: SIMD3<Float>, rayDirection: SIMD3<Float>, planeY: Float = groundY) -> SIMD3<Float>? {
    ...
    static func projectPointAlongLightDirection(vertexPosition: SIMD3<Float>, lightDirection: SIMD3<Float>, planeY: Float = groundY) -> SIMD3<Float>? {
    ...
    static func projectPointFromLight(lightPosition: SIMD3<Float>, objectPoint: SIMD3<Float>, planeY: Float = groundY) -> SIMD3<Float>? {
    ...
    static func approximateShadowLength(lightDirection: SIMD3<Float>, objectHeight: Float) -> Float? {
    ...
    private static func cubeTopVertices(center: SIMD3<Float>) -> [SIMD3<Float>] {
        let halfSize: Float = 0.12 / 2
        let topY = center.y + halfSize
        
        return [
            SIMD3<Float>(center.x - halfSize, topY, center.z - halfSize),
            SIMD3<Float>(center.x + halfSize, topY, center.z - halfSize),
            SIMD3<Float>(center.x + halfSize, topY, center.z + halfSize),
            SIMD3<Float>(center.x - halfSize, topY, center.z + halfSize)
        ]
